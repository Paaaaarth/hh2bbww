...
config_categories = DotDict({
    "default": [
        "sr__2b__ml_hhh_4b2w2l2nu_c30_d40",
        "sr__2b__ml_hh",
        "sr__2b__ml_h",
        "sr__2b__ml_tt+st",
        "sr__2b__ml_dy",
        "sr__3b__ml_hhh_4b2w2l2nu_c30_d40",
        "sr__3b__ml_tthh_4b",
        "sr__3b__ml_tth",
        "sr__3b__ml_di_top_3b",
        "sr__4b__ml_hhh_4b2w2l2nu_c30_d40",
        "sr__4b__ml_tthh_4b",
        "sr__4b__ml_tth",
        "sr__4b__ml_di_top_4b",
    ],
})
...
systematics = DotDict({
    ...
    "pdf": [
        "pdf_gg", # tttt was causing issues with pdf weights, so skipping for now
        "pdf_qqbar",
        "pdf_qg",
        "pdf_Higgs_gg",
        "pdf_Higgs_qqbar",
...
processes_dict = {
    "hhh": [
        ...
        "dy",
        "vv",
        "h_ggf", "h_vbf", "zh", "wh", "zh_gg", "tth", "hh",
        ]

}

from hbw.ml.derived.dl import input_features
mli_inputs = input_features.reduced
...
dl_combo_multi_binary = dl.derive("dl_combo_multi_binary", cls_dict={
    "ml_model_name": ["dl_combo_multi", "dl_combo_binary"],
    "config_variable": lambda self, config_cat_inst: "logit_mlscore.sig_binary",
    "systematics": systematics.rate,
})
...
full_cat_multi_binary = dl.derive("full_cat_multi_binary", cls_dict={
    "ml_model_name": ["full_multi_2b", "full_multi_3b", "full_multi_4b", "full_binary"],
    "config_variable": lambda self, config_cat_inst: "logit_mlscore.sig_binary",
    "systematics": systematics.rate,
})